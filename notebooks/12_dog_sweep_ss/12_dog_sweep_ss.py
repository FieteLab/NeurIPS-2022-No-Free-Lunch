...
# Declare variables.
notebook_dir = 'notebooks/08_dog_sweep_rf'
...
sweep_ids = [
    'acmd4be7',  # DoG sweeping surround scale size
]
...
plot_grid_periods_mode_ratios_vs_index(
...
plot_grid_periods_kde_facet_by_place_cell_rf(
    augmented_neurons_data_by_run_id_df=augmented_neurons_data_by_run_id_df,
    plot_dir=results_dir)
