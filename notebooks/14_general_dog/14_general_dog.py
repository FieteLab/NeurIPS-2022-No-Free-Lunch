...
# Keep only ReLU runs
runs_configs_general_dog_df = runs_configs_general_dog_df[
    runs_configs_general_dog_df['activation'] == 'relu']
...
general_dog_joblib_files_data_by_run_id_dict = load_runs_joblib_files(
    ...
    include_additional_data=True,  # Necessary to plot ratemaps.
)
...
# Save max-grid-score-by-key-parameters to disk for additional analysis.
tmp = runs_configs_general_dog_df[['activation', 'place_cell_alpha_e',
                                   'place_cell_alpha_i', 'place_cell_rf',
                                   'score_60_by_neuron_max',
                                   'score_90_by_neuron_max']]
tmp.to_csv(
...
runs_configs_general_dog_df['human_readable_sweep'] = runs_configs_general_dog_df.apply(
...
augmented_neurons_data_by_run_id_df = runs_configs_general_dog_df[[
    'human_readable_sweep', 'activation',
